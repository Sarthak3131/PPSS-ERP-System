...
export default function BOMControls({
    search,
    onSearchChange,
    rowsPerPage,
    onRowsPerPageChange,
    ...
    return (
        <div className="erp-panel flex flex-wrap items-center justify-between gap-2 px-4 py-3">
            <div className="flex min-w-0 flex-1 items-center">
                <div className="w-full sm:w-56">
                    <FormInput
                        ...
                        placeholder="Search product or component"
            ...
            <div className="flex flex-wrap items-end justify-end gap-1.5 sm:gap-2">
                <div className="w-36">
                    <Select id="bom-rows-per-page" value={String(rowsPerPage)} onChange={(e) => onRowsPerPageChange && onRowsPerPageChange(Number(e.target.value))} aria-label="Rows per page">
                        {[5, 10, 15, 20].map((size) => (
