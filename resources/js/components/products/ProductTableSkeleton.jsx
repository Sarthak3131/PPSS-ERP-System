...
function SkeletonBar({ className = '' }) {
    return <div className={`animate-pulse rounded-full bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 bg-[length:200%_100%] dark:from-slate-700 dark:via-slate-600 dark:to-slate-700 ${className}`} />;
}
        ...
        <div className="erp-panel overflow-hidden p-0">
            ...
            <div className="divide-y divide-[var(--erp-border)]">
                {Array.from({ length: 6 }).map((_, index) => (
                    <div key={index} className="grid grid-cols-1 gap-3 px-4 py-4 md:grid-cols-12 md:items-center">
